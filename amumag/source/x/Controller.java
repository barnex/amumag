...
public final class Controller extends JPanel{
     ...
     **/
    public Controller(DR2DRenderer r){
        this.renderer = r;
        Cell[][][][] levels = renderer.mesh.levels;
        ...
        radio[renderer.getView()].setSelected(true);
        for(int i=0; i<3; i++){
        ...
        setLevel(renderer.getLevel());
        setSlice(renderer.getSlice());
        
        // checkboxes
        gbc.gridx = 0;
        gbc.gridwidth = 3;
       
//        final boolean[] draw = renderer.draw;
