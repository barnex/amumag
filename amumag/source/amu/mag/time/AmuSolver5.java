 ...
 * @author arne
 */
public class AmuSolver5 extends AmuSolver{
    ...
    public AmuSolver5(double maxDphi, boolean adaptiveStep, int fastSteps, int subSteps){
        if(maxDphi <= 0.0)
    ...
    public AmuSolver5(double maxDphi, int fastSteps, int subSteps){
